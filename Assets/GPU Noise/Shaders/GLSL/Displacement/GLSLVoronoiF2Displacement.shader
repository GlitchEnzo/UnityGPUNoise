Shader "GPU Noise/GLSL/Voronoi F2 Displacement" 
{
    Properties 
    {
        time ("time", float) = 0
    ...
    SubShader 
    {
        Pass 
        {
            ...
            { 
				...
				float heightValue = voronoif2(vec3(texcoord * noiseScale)) * heightScale;
            ...
            void main()
            {                
                float result = voronoif2(vec3(TexCoord * noiseScale));
